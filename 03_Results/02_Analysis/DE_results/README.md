...
**Generated by:** `02_Analysis/1.1.main_pipeline.R` and `02_Analysis/1.2.generate_contrast_tables.R`
...
### Current Files (`*_results.csv`)

| File | Contrast | Biological Question | Genes |
|------|----------|---------------------|-------|
| `G32A_vs_Ctrl_D35_results.csv` | G32A vs Control at Day 35 | Early G32A mutation effect | 21,122 |
| `G32A_vs_Ctrl_D65_results.csv` | G32A vs Control at Day 65 | Late G32A mutation effect | 21,122 |
| `R403C_vs_Ctrl_D35_results.csv` | R403C vs Control at Day 35 | Early R403C mutation effect | 21,122 |
| `R403C_vs_Ctrl_D65_results.csv` | R403C vs Control at Day 65 | Late R403C mutation effect | 21,122 |
| `Time_Ctrl_results.csv` | D65 - D35 in Controls | Normal maturation | 21,122 |
| `Time_G32A_results.csv` | D65 - D35 in G32A | G32A maturation | 21,122 |
| `Time_R403C_results.csv` | D65 - D35 in R403C | R403C maturation | 21,122 |
| `Maturation_G32A_specific_results.csv` | Interaction term | G32A-specific trajectory deviation | 21,122 |
| `Maturation_R403C_specific_results.csv` | Interaction term | R403C-specific trajectory deviation | 21,122 |

All files generated from the same checkpoint (`contrast_tables.rds`) on 2026-01-13 to ensure statistical consistency.
...
|-----------|-------|-----------------|
| p_cutoff | 0.05 | `config$p_cutoff` in 1.1.main_pipeline.R |
| fc_cutoff | 2 (|log2FC| > 1) | `config$fc_cutoff` in 1.1.main_pipeline.R |
...
# Load results
de <- read.csv("G32A_vs_Ctrl_D35_results.csv", row.names = 1)
...
# Load results
de = pd.read_csv("G32A_vs_Ctrl_D35_results.csv", index_col=0)
...
```r
# In 02_Analysis/1.1.main_pipeline.R
contrast_tables <- process_all_contrasts(fit, contrasts, number = Inf, sort_by = "t")
save_contrast_csvs(contrast_tables, deg_dir, suffix = "_results.csv")
```
...
| Date | Change | Files | Changes |
|------|--------|-------|---------|
| 2026-01-13 | Cleaned up and regenerated all from checkpoint | All 9 *_results.csv | Removed legacy duplicates, consistent naming, verified 21,122 genes |
| 2024-11-19 | Initial generation | All *_results.csv | First pipeline run |
